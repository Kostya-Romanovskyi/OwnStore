...
} from "../../Redux/Slices/UpcomingMoviesSlice";
import "./Upp.css";
import {
    Section,
    UpcomingMovies,
        ...
        <>
            ...
            {!upcomingLoading ? (
                <Section>
                    <UpcomingMovies>
                        Upcoming movies{" "}
                        <WatchAllLink to={"/upcoming"}>watch all</WatchAllLink>{" "}
                    </UpcomingMovies>
                    <ListWrapper>
                        {threeEl &&
                            threeEl.map(
                                                    ...
                                                    <InfoWrapp>
                                                        {index === 0 && screenWidth > 768 ? (
                                                            <TitleWrapp
                                                                ...
                                                                {index === 0 && screenWidth > 1200 ? (
                                                                    <LikeButton style={{ marginBottom: 23 }}>
                                                                        {original_language}
                                                                    </LikeButton>
                                                                ) : (
